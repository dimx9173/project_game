...
```text
+======================================================================+
|  [系統LOGO]    [儀表板] [機台] [遊戲] [玩家] [交易] [代理] [權限]   |
+======================================================================+
|                                                                      |
|  ████ 戰情室 Dashboard ████                                         |
|                                                                      |
|  +---------------------------+  +---------------------------+        |
|  |   昨日 vs 今日 營收圖     |  |     機台狀態 圓餅圖      |        |
|  |   [=================]     |  |   🟢 45台  🔴 5台         |        |
|  |   [=================]     |  |                           |        |
|  |   昨日: $120,000         |  |   [███████████░░░] 90%    |        |
|  |   今日: $145,000         |  |                           |        |
...
|                                                                      |
|  +----------------------------------------------------------------+  |
|  | 機台編號 | 狀態 │ 位置   │ 今日營收 │ 最後心跳 │             |  |
|  |----------|------|---------|-----------|----------|             |  |
|  | A-01     | 🟢   | 門市A  | $12,500   | 1分鐘前  |             |  |
|  | A-02     | 🔴   | 門市B  | $8,200    | 15分鐘前 |             |  |
|  | A-03     | 🟢   | 門市C  | $15,000   | 30秒前   |             |  |
|  +----------------------------------------------------------------+  |
|                                                                      |
+======================================================================+
```
...
|  | 🔍 搜尋代理商... | [新增代理商] [匯出]                        |  |
|  +----------------------------------------------------------------+  |
|  | # | 代理商名稱 | 代表人 | 機台數 | 今日營收 | 狀態 | 操作    |  |
|  |---|------------|---------|--------|----------|------|----------|  |
|  | 1 | 北部代理   | 張小明 | 15台   | $45,000  | 正常 | [詳情] |  |
|  | 2 | 南部代理   | 李小華 | 20台   | $62,000  | 正常 | [詳情] |  |
|  | 3 | 中部代理   | 王小明 | 10台   | $28,000  | 停權 | [詳情] |  |
|  +----------------------------------------------------------------+  |
|                                                                      |
+======================================================================+
```
...
|                                                                      |
|  +----------------------------------------------------------------+  |
|  | 遊戲商 | API狀態 | 連線數 | 今日轉入 | 今日轉出 | 操作       |  |
|  |--------|---------|--------|----------|----------|------------|  |
|  | PT平台 | 🟢正常  | 45     | $120,000 | $95,000  | [詳情]    |  |
|  | MG遊戲 | 🟢正常  | 28     | $68,000  | $52,000  | [詳情]    |  |
|  | PP遊戲 | 🔴異常  | 0      | $0       | $0       | [設定]    |  |
|  +----------------------------------------------------------------+  |
|                                                                      |
+======================================================================+
...
**【情境說明】** 代理商登入系統，只能看到自己名下的機台營收和狀態。

**【主要角色】** 代理商

1. 代理商輸入帳號密碼登入中央後台。
2. 系統根據 RBAC 權限，只顯示該代理商相關的機台資料。
3. 代理商可以查看自己機台的營收統計，但無法修改系統設定。
4. 代理商可以建立下線操作員帳號。
...
| 版本 | 日期 | 變更說明 |
|------|------|----------|
| v6.2 | 2026-02-25 | 整合 UI設計 + 文字框 + UseCase，三層權限 |
