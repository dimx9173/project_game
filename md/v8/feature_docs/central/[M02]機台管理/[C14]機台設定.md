...
|------|--------|----------|------|
| 取得設定 | GET | `/api/v1/machines/{instanceId}/settings` | 取得機台目前設定 |
| 更新網路設定 | PUT | `/api/v1/machines/{instanceId}/settings/network` | 更新網路參數 |
| 同步時間 | POST | `/api/v1/machines/{instanceId}/settings/time-sync` | 強制時間同步 |
| 更新營運參數 | PUT | `/api/v1/machines/{instanceId}/settings/operation` | 更新營運參數 |
